...
class ContractDetails(object):
	...
	self.m_longName = long_name
	self.m_contractMonth = contract_month
	self.m_industry = industry
	self.m_category = category
	self.m_subcategory = subcategory
	self.m_timeZoneId = time_zone_Id
	self.m_tradingHours = trading_hours
	self.m_liquidHours = liquid_hours
        # Non-parameterized
        self.m_cusip = ""
        self.m_ratings = ""
        self.m_descAppend = ""
...
#This part is commented because contract Details should not be copied anyway, correct?
